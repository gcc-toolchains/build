...
KERNEL_ABS_PATH := $(TOPDIR)kernel/$(KERNEL_PATH)
...
GLIBC_LINUXTHREADS_PATH := glibc-linuxthreads-$(GLIBC_LINUXTHREADS_VERSION)
GLIBC_LINUXTHREADS_ABS_PATH := $(TOPDIR)glibc-linuxthreads/$(GLIBC_LINUXTHREADS_PATH)
endif # TARGET_LIBC
...
TOOLCHAINS_SYSROOT := $(TOOLCHAINS_PREFIX)/$(TARGET)/libc
